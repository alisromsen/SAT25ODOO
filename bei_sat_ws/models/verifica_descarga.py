    ...
    def create(self, vals):
        ...
        if vals.get('name', 'New') == 'New':
            ...
            if 'start_date' in vals and 'end_date' in vals:
                # Asegúrate de que el rango DE FECHA no exceda 31 días si estás haciendo solicitudes frecuentes, para evitar rechazos por volumen.
                # Calcular diferencia en días
                diferencia = (vals['end_date'] - vals['start_date']).days
                # Validar
