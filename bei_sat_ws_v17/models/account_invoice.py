...
class AccountInvoice(models.Model):
    ...
    #     _logger.info(" *******COMPUTE CFDI UUID 3333333333333333333333333333333333333333333333333*********")
    #     for inv in self:
    #         attachment_id = inv._get_l10n_mx_edi_signed_edi_document()
    #         if not attachment_id:
    #             _logger.info("not attachment_id")
    ...
    #
    #         else:
    #             _logger.info("siiiiiiiiiiii attachment_id")
    #             cfdi_infos = inv._l10n_mx_edi_decode_cfdi()
    #             _logger.info(cfdi_infos.get('UUID'))
